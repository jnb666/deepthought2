...
enum {COPY, COPY_TO_DEVICE, COPY_TO_HOST, COPY_COL, TILE0, TILE1, FILL, NEQ,
	ONEHOT, UNHOT, SCALE, AXPY, SQUARE, SQRT, MIN, MAX, TRANS, SUM, GEMV, GEMM,
	MUL_ELEM, DIV_ELEM,	SIGMOID, SIGMOID_D, TANH, TANH_D, RELU, RELU_D,
